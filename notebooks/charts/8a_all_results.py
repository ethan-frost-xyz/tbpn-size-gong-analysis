...
def generate_chart():
    ...
    colors = [get_marker_color(master) for master in df['Gong Master']]

    # Style markers
    fig.update_traces(
        marker={"color": colors, "size": 5, "opacity": .8, "line": {"width": 0}},
...
'''
    ...
    output_path = output_dir / "8a_all_results.html"

...
def process_audio_with_yamnet(temp_audio: str, threshold: float) -> Tuple[List[Tuple[float, float]], float, float]:
...
Examples:
  ...
  python detect_from_youtube.py "https://www.youtube.com/watch?v=VIDEO_ID" --threshold 0.3 --save_csv results.csv
    ...
    parser.add_argument("--start_time", type=int, help="Start time in seconds (optional)")

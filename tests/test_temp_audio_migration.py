...
def test_temp_audio_file_creation():
    ...
    from gong_detector.core.utils.youtube_utils import setup_directories, create_temp_audio_path
...
def test_all_imports_work():
    ...
    try:
        from gong_detector.core.utils.youtube_utils import setup_directories, create_temp_audio_path
        from gong_detector.core.pipeline.detection_pipeline import main
        from gong_detector.core.training.manual_collector import main as manual_collector_main
        from gong_detector.core.training.negative_collector import main as negative_collector_main
...
def test_temp_audio_cleanup():
    ...
    from gong_detector.core.utils.youtube_utils import setup_directories, create_temp_audio_path, cleanup_old_temp_files

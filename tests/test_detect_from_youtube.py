...
class TestYouTubeDownloadAndTrim:
    ...
    @patch('os.listdir')
    def test_download_youtube_audio_success(self, mock_listdir: Mock, mock_ydl_class: Mock) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = _download_youtube_audio("https://youtube.com/watch?v=test", output_template)
    ...
    @patch('gong_detector.core.detect_from_youtube.yt_dlp.YoutubeDL')
    @patch('os.listdir')
    def test_download_youtube_audio_no_files(self, mock_listdir: Mock, mock_ydl_class: Mock) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with pytest.raises(RuntimeError, match="Failed to download audio from YouTube"):
                _download_youtube_audio("https://youtube.com/watch?v=test", output_template)
...
class TestOutputAndSummary:
    ...
    @patch('gong_detector.core.detect_from_youtube.YAMNetGongDetector')
    def test_save_results_to_csv_adds_extension(self, mock_detector_class: Mock) -> None:
...
class TestYAMNetProcessing:
    ...
    @patch('gong_detector.core.detect_from_youtube.YAMNetGongDetector')
    def test_process_audio_with_yamnet_complete_workflow(self, mock_detector_class: Mock) -> None:
        ...
        # Run processing
        detections, duration, max_confidence = process_audio_with_yamnet("test.wav", 0.5)

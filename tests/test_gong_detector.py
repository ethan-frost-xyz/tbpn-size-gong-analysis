...
def test_project_structure():
    ...
    assert (base_dir / "src" / "gong_detector").exists(), "gong_detector package should exist"
    assert (base_dir / "src" / "gong_detector" / "core").exists(), "core module should exist"
    assert (base_dir / "src" / "gong_detector" / "core" / "detector").exists(), "detector module should exist"
    assert (base_dir / "src" / "gong_detector" / "core" / "pipeline").exists(), "pipeline module should exist" 